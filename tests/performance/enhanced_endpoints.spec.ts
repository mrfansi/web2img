...
test.group('Enhanced Endpoints - Performance Tests', (group) => {
  ...
  group.each.teardown(async () => {
    ...
    try {
      ...
      console.warn('Failed to clean up batch jobs in enhanced endpoints performance test:', error)
    }
  })
  ...
  group.teardown(async () => {
    ...
    try {
      ...
      console.warn('Failed to clean up batch jobs in enhanced endpoints performance teardown:', error)
    }
